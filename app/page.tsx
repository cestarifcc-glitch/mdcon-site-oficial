...
const faqs=[
  ...
  ['Qual região de atuação da MDCon?','A MDCon está localizada em Palmeira das Missões–RS e atende clientes em todo o Brasil.'],
...
export default function Home(){return <>
    ...
    <div className="container hero-grid">
      ...
      <div className="hero-photo-wrap">
        <div className="hero-photo-card">
          <Image src="/mdcon-fachada.png" alt="Fachada da MDCon Assessoria Contábil em Palmeira das Missões" fill priority sizes="(max-width: 900px) 100vw, 48vw" className="hero-photo" />
  ...
  <section className="section about-team"><div className="container about-team-grid about-team-no-photo"><div className="about-team-copy"><div className="about-team-heading"><span className="eyebrow">SOBRE A MDCON</span><h2>Contabilidade feita por pessoas que acompanham o seu negócio.</h2></div><div className="about-team-text"><p>A MDCon une experiência, proximidade e organização para apoiar empresas nas rotinas contábeis, fiscais e trabalhistas.</p><p>Em Palmeira das Missões, nossa equipe trabalha lado a lado com cada cliente, buscando um atendimento claro, responsável e próximo.</p><Link className="btn btn-primary" href="/sobre">Conheça a MDCon</Link></div></div></div></section>
<section className="section services-premium"><div className="container">
    <div className="section-head services-title">
      ...
      <p>Contabilidade organizada, atendimento próximo e orientação para acompanhar cada fase da sua empresa.</p>
    </div>
    <div className="services-grid featured-services">
  ...
  <section className="local-section"><div className="container local-grid"><div className="local-photo"><Image src="/palmeira-das-missoes.jpg" alt="Vista de Palmeira das Missões, Rio Grande do Sul" fill sizes="(max-width: 900px) 100vw, 48vw" className="local-photo-img" /></div><div><span className="eyebrow">PRESENÇA LOCAL</span><h2>Presença local, relacionamento próximo.</h2><p>Em Palmeira das Missões, a MDCon acompanha de perto empresas, empreendedores, produtores rurais e pessoas físicas, unindo conhecimento contábil à compreensão da realidade da nossa região.</p><Link className="btn btn-primary" href="/sobre">Conheça a MDCon</Link></div></div></section>
