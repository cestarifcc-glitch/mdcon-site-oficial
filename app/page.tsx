...
<section className="section services-premium"><div className="container">
  ...
  <section className="local-section"><div className="container local-grid"><div className="local-photo"><Image src="/palmeira-das-missoes.jpg" alt="Vista aérea de Palmeira das Missões, Rio Grande do Sul" fill sizes="(max-width: 900px) 100vw, 48vw" className="local-photo-img" /></div><div><span className="eyebrow">PRESENÇA LOCAL</span><h2>Presença local, relacionamento próximo.</h2><p>Em Palmeira das Missões, a MDCon acompanha de perto empresas, empreendedores, produtores rurais e pessoas físicas, unindo conhecimento contábil à compreensão da realidade da nossa região.</p><Link className="btn btn-primary" href="/sobre">Conheça a MDCon</Link></div></div></section>
